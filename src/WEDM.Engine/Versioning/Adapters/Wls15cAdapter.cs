...
internal sealed class Wls15cAdapter : IWebLogicVersionAdapter
{
    public WebLogicVersion Version      => WebLogicVersion.WLS_15c;
    public string          VersionLabel => "WebLogic 15c";
    ...
    public IReadOnlyList<string> RequiredMediaPatterns =>
        ["fmw_15", "wls", "ofm_wls", "15."];

    public string RequiredMediaDescription =>
        "Fusion Middleware / WebLogic 15c installer media from Oracle eDelivery.";
    ...
    public string NodeManagerPropertiesTemplate =>
        """
        #Node manager properties — WebLogic 15c
